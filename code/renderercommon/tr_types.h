...
// This has to match JKA's version since it's part of cgs_t (i.e. visible to cgame)
typedef struct {
	// JKA: hack to keep these strings limited but have the pointer versions in the struct like jka - points to string in tr_local.h
